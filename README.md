# Инструкция по работе со сборщиком
...
### Спрайты иконок
* иконки находятся в папке ```src/svgicons```
    * все svg файлы, загруженные в папку ```src/svgicons``` будут собраны в спрайт ```dist/img/icons/icons.svg```.
    * выводятся иконки следуюхим образом: ```<img src="@img/icons/icons.svg#file_name" alt="">```, где ```file_name``` это название файла в папке ```src/svgicons```
